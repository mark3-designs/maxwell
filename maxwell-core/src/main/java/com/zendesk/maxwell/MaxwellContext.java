...
public class MaxwellContext {
	...
	private static Map<String, Function<MaxwellContext, AbstractProducer>> producerMap = new HashMap<>();
	...
	public static void registerProducer(String type, Function<MaxwellContext, AbstractProducer> producer) {
		producerMap.put(type, producer);
	}
